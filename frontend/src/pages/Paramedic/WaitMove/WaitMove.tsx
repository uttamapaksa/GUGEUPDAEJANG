      ...
      <S.ParamedicHeader>
        ...
        <S.ContentBox>
          ...
          <S.HospitalList>
            ...
            <S.HospitalItem>
              <div style={{display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', width: '100%', border: '1px solid red'}}>
                <S.ItemTitle>연세대학교 의과대학 강남세브란스 병원</S.ItemTitle>
                <S.ItemCallTime>10시 18분에 요청</S.ItemCallTime>
              </div>
              <div style={{display: 'flex', justifyContent: 'space-between', alignItems:'end', flexWrap: 'wrap', width: '100%', border: '1px solid red'}}>
              <S.ItemNumber>02-2602-3024</S.ItemNumber>
          ...
          <S.HospitalList>
            <S.TotalInformation>
                ...
                <A.DivTag
                  ...
                  $backgroundColor={theme.color.grayDarkest}>청소년 (여)
                </A.DivTag>
