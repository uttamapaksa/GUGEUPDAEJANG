...
class CallingServiceImplTest {
    ...
    void setCallingRequest() {
        ...
        longitude = 127.22;
        distance = 10.0;
        callingCreateRequest = new CallingCreateRequest(KTAS.KTAS2, AgeGroup.YOUTH, Gender.MALE, "아파요", latitude, longitude, tags, files);
    ...
    void 사고_사고파일_사고태그를_저장한다() throws Exception {
        ...
        callingService.addOccurrence(paramedicMemberId, callingCreateRequest);
    ...
    void 요청을_저장한다() throws Exception {
        ...
        callingService.addCalling(callingCreateRequest, occurrence);
